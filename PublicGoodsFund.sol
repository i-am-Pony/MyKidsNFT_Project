...
// we added a second payout address for charity / donations to Public Goods Fund
        ...
        /// This will donate 20% of all donations to Optimism. ((In theory, it is currently set to the 
        ...
        (bool hs, ) = payable(0x4200000000000000000000000000000000000042).call{value: address(this).balance * 60 / 100}("Optimism");
        require(hs);
        /// This will send the Community Donation Wallet the remaining 80% of all donations for
